...
ax0= plt.subplot(gs[0,0])
im=ax0.imshow(Mcovar_noise,origin='lower',interpolation='none',cmap=plt.cm.inferno
          ,extent=[log_k_bins[0],log_k_bins[-1],log_k_bins[0],log_k_bins[-1]]
...
plt.tight_layout()
plt.subplots_adjust(wspace=.0)
plt.savefig('covariance_matrix/covariance_matrix_noise_dk%.2f_%dkbins_z%.1f_fX%.2f_xHI%.2f_%s_%dkHz_t%dh_Smin%.1fmJy_alphaR%.2f_%dLOS.png' % (d_log_k_bins,len(k_bins_cent),z_name,logfX_mock,xHI_mean_mock,telescope,spec_res,tint,S147,alphaR,Nobs))
plt.show()
plt.close()
...
ax0= plt.subplot(gs[0,0])
im=ax0.imshow(Mcovar_sv,origin='lower',interpolation='none',cmap=plt.cm.inferno
          ,extent=[log_k_bins[0],log_k_bins[-1],log_k_bins[0],log_k_bins[-1]]
          ,aspect='auto',norm=LogNorm(vmin=3e-18,vmax=6e-13))
...
plt.tight_layout()
plt.subplots_adjust(wspace=.0)
plt.savefig('covariance_matrix/covariance_matrix_SV_dk%.2f_%dkbins_z%.1f_fX%.2f_xHI%.2f_%s_%dkHz_t%dh_Smin%.1fmJy_alphaR%.2f_%dLOS.png' % (d_log_k_bins,len(k_bins_cent),z_name,logfX_mock,xHI_mean_mock,telescope,spec_res,tint,S147,alphaR,Nobs))
plt.show()
plt.close()
...
ax0= plt.subplot(gs[0,0])
im=ax0.imshow(Mcovar_mock,origin='lower',interpolation='none',cmap=plt.cm.inferno
          ,extent=[log_k_bins[0],log_k_bins[-1],log_k_bins[0],log_k_bins[-1]]
          ,aspect='auto',norm=LogNorm(vmin=3e-18,vmax=6e-13))
...
plt.tight_layout()
plt.subplots_adjust(wspace=.0)
plt.savefig('covariance_matrix/covariance_matrix_SVandN_dk%.2f_%dkbins_z%.1f_fX%.2f_xHI%.2f_%s_%dkHz_t%dh_Smin%.1fmJy_alphaR%.2f_%dLOS.png' % (d_log_k_bins,len(k_bins_cent),z_name,logfX_mock,xHI_mean_mock,telescope,spec_res,tint,S147,alphaR,Nobs))
plt.show()
plt.close()