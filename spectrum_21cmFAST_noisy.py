...
plt.legend(frameon=False,loc='upper left',fontsize=fsize,ncols=2)
...
plt.savefig('spectrum/noisy_spectrum_200Mpc_z%.1f_fX%.2f_xHI%.2f_%s_%dkHz_Smin%.1fmJy_alphaR%.2f_t%dh_%dLOS_nonoise.png' % (z,fX_name,xHI_mean,telescope,spec_res,S_min_QSO,alpha_R,t_int,LOS))
plt.show()